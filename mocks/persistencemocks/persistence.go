...
func (_m *Persistence) ListListeners(ctx context.Context, after *fftypes.UUID, limit int, dir toolkit.SortDirection) ([]*apitypes.Listener, error) {
	ret := _m.Called(ctx, after, limit, dir)

	var r0 []*apitypes.Listener
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection) ([]*apitypes.Listener, error)); ok {
		return rf(ctx, after, limit, dir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection) []*apitypes.Listener); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection) error); ok {
...
func (_m *Persistence) ListStreamListeners(ctx context.Context, after *fftypes.UUID, limit int, dir toolkit.SortDirection, streamID *fftypes.UUID) ([]*apitypes.Listener, error) {
	ret := _m.Called(ctx, after, limit, dir, streamID)

	var r0 []*apitypes.Listener
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection, *fftypes.UUID) ([]*apitypes.Listener, error)); ok {
		return rf(ctx, after, limit, dir, streamID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection, *fftypes.UUID) []*apitypes.Listener); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection, *fftypes.UUID) error); ok {
...
func (_m *Persistence) ListStreams(ctx context.Context, after *fftypes.UUID, limit int, dir toolkit.SortDirection) ([]*apitypes.EventStream, error) {
	ret := _m.Called(ctx, after, limit, dir)

	var r0 []*apitypes.EventStream
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection) ([]*apitypes.EventStream, error)); ok {
		return rf(ctx, after, limit, dir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *fftypes.UUID, int, toolkit.SortDirection) []*apitypes.EventStream); ok {
		r0 = rf(ctx, after, limit, dir)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*apitypes.EventStream)
...
func (_m *Persistence) ListTransactionsByCreateTime(ctx context.Context, after *apitypes.ManagedTX, limit int, dir toolkit.SortDirection) ([]*apitypes.ManagedTX, error) {
	ret := _m.Called(ctx, after, limit, dir)

	var r0 []*apitypes.ManagedTX
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *apitypes.ManagedTX, int, toolkit.SortDirection) ([]*apitypes.ManagedTX, error)); ok {
		return rf(ctx, after, limit, dir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *apitypes.ManagedTX, int, toolkit.SortDirection) []*apitypes.ManagedTX); ok {
		r0 = rf(ctx, after, limit, dir)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*apitypes.ManagedTX)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *apitypes.ManagedTX, int, toolkit.SortDirection) error); ok {
		r1 = rf(ctx, after, limit, dir)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Persistence) ListTransactionsByNonce(ctx context.Context, signer string, after *fftypes.FFBigInt, limit int, dir toolkit.SortDirection) ([]*apitypes.ManagedTX, error) {
	ret := _m.Called(ctx, signer, after, limit, dir)

	var r0 []*apitypes.ManagedTX
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *fftypes.FFBigInt, int, toolkit.SortDirection) ([]*apitypes.ManagedTX, error)); ok {
		return rf(ctx, signer, after, limit, dir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *fftypes.FFBigInt, int, toolkit.SortDirection) []*apitypes.ManagedTX); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *fftypes.FFBigInt, int, toolkit.SortDirection) error); ok {
...
func (_m *Persistence) ListTransactionsPending(ctx context.Context, afterSequenceID string, limit int, dir toolkit.SortDirection) ([]*apitypes.ManagedTX, error) {
	ret := _m.Called(ctx, afterSequenceID, limit, dir)

	var r0 []*apitypes.ManagedTX
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int, toolkit.SortDirection) ([]*apitypes.ManagedTX, error)); ok {
		return rf(ctx, afterSequenceID, limit, dir)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int, toolkit.SortDirection) []*apitypes.ManagedTX); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, int, toolkit.SortDirection) error); ok {
