...
// GetConfirmationFilter provides a mock function with given fields: ctx
func (_m *RichQuery) GetConfirmationFilter(ctx context.Context) *ffapi.QueryFields {
	ret := _m.Called(ctx)

	var r0 *ffapi.QueryFields
	if rf, ok := ret.Get(0).(func(context.Context) *ffapi.QueryFields); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ffapi.QueryFields)
		}
	}
...
// GetListenerFilter provides a mock function with given fields: ctx
func (_m *RichQuery) GetListenerFilter(ctx context.Context) *ffapi.QueryFields {
	ret := _m.Called(ctx)
...
// GetStreamFilter provides a mock function with given fields: ctx
func (_m *RichQuery) GetStreamFilter(ctx context.Context) *ffapi.QueryFields {
	ret := _m.Called(ctx)
...
// GetTransactionFilter provides a mock function with given fields: ctx
func (_m *RichQuery) GetTransactionFilter(ctx context.Context) *ffapi.QueryFields {
	ret := _m.Called(ctx)
...
// GetTxHistoryFilter provides a mock function with given fields: ctx
func (_m *RichQuery) GetTxHistoryFilter(ctx context.Context) *ffapi.QueryFields {
	ret := _m.Called(ctx)
