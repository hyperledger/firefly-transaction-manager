...
func TestHandleTransactionProcessFailedEvent(t *testing.T) {
	_, m, close := newTestManager(t)
	defer close()
...
func TestHandleTransactionDeletedEvent(t *testing.T) {
	_, m, close := newTestManager(t)
	defer close()
...
func TestHandleTransactionHashUpdateEvent(t *testing.T) {
	_, m, close := newTestManager(t)
	defer close()
