...
// 	Path                 string               `ffstruct:"eventstream" json:"path"`
// 	Suspended            bool                 `ffstruct:"eventstream" json:"suspended"`
// 	Type                 string               `ffstruct:"eventstream" json:"type,omitempty"`
// 	BatchSize            *uint64              `ffstruct:"eventstream" json:"batchSize,omitempty"`
// 	BatchTimeoutMS       *uint64              `ffstruct:"eventstream" json:"batchTimeoutMS,omitempty"`
// 	ErrorHandling        string               `ffstruct:"eventstream" json:"errorHandling,omitempty"`
// 	RetryTimeoutSec      uint64               `ffstruct:"eventstream" json:"retryTimeoutSec,omitempty"`
// 	BlockedRetryDelaySec *uint64              `ffstruct:"eventstream" json:"blockedRetryDelaySec,omitempty"`
// 	Webhook              *WebhookActionInfo   `ffstruct:"eventstream" json:"webhook,omitempty"`
// 	WebSocket            *WebSocketActionInfo `ffstruct:"eventstream" json:"websocket,omitempty"`
// 	Timestamps           bool                 `ffstruct:"eventstream" json:"timestamps,omitempty"`
// 	Inputs               bool                 `ffstruct:"eventstream" json:"inputs,omitempty"`
// }
