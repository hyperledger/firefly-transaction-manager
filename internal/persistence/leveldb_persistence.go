...
func (p *leveldbPersistence) ListTransactionsPending(ctx context.Context, afterSequenceID string, limit int, dir toolkit.SortDirection) ([]*apitypes.ManagedTX, error) {
