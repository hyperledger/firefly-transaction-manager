...
var (
	...
	MsgBlockListenerNoOutputChannel                     = ffe("FF21093", "Block listener must have at least one output channel for block events or confirmations")
	MsgBlockListenerBothOutputChannels                  = ffe("FF21094", "Block listener cannot have both block event and confirmation output channels", http.StatusBadRequest)
	MsgListenerTypeNotSupportedForConfirmationStreaming = ffe("FF21095", "Listener type '%s' is not supported for confirmations streaming", http.StatusBadRequest)
)
