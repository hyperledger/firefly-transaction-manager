...
var (
	...
	ConfigPolicyEngineSimpleGasStationQueryInterval = ffc("config.policyengine.simple.gasstation.queryInterval", "The minimum interval between queries to the Gas Station API", "duration")
)
