...
var (
	...
	MsgPostgresURLMissing                      = ffe("FF21081", "URL must be supplied for Postgres persistence")
	MsgPersistenceQueryBuildFailed             = ffe("FF21082", "Persistence query builder failed")
